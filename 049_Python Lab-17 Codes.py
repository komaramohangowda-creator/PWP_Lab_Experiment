...
import sympy as sp
z = sp.symbols('z')
X = 1 / (1 - 3/z)   # Z-transform of 3^n u[n]
print("Z-transform of 3^n u[n] =", X.simplify())

import math
z = 2       
w = 0.5
numerator = z * (z - math.cos(w))
denominator = z**2 - 2*z*math.cos(w) + 1
X = numerator / denominator
print("Z-transform of cos(w n) u[n] =", X)
